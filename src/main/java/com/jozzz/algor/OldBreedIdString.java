...
public class OldBreedIdString {

    private static ArrayList<String[]> listAllBreedMain;
    
    public static ArrayList<String[]> splitPattern(ArrayList<String[]> data , ArrayList<String[]> selectedBreed) {
...
//                 }
//             }
//             value[9] = String.valueOf(sum);

//             value[8] = isCorrectBreed(dataArr[0], dataArr[2])
//                     ? dataArr[0] + ":" + dataArr[2] : "";
